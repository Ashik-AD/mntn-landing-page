const [imgSky, imgMountain, imgHuman] = document.querySelectorAll(
  ".bg__img-sky, .bg__img-mountain, .bg__img-human",
) as any;
...
function parallax() {
  ...
  imgMountain.style.transform = `translate3d(0px, ${-(shiftBy * 4.5)}%, 0px)`;
